...
use crate::sketch::minhash::{
    aa_to_dayhoff, aa_to_hp, revcomp, to_aa, HashFunctions, Intersection, VALID,
};

#[derive(Debug, Clone, PartialEq, TypedBuilder)]
pub struct KmerModHash {
    ksize: u32,
...
impl Default for KmerModHash {
    fn default() -> KmerModHash {
        KmerModHash {
            ksize: 21,
...
impl Serialize for KmerModHash {
        ...
        S: Serializer,
    {
        ...
        let mut partial = serializer.serialize_struct("KmerModHash", n_fields)?;
        partial.serialize_field("ksize", &self.ksize)?;
        partial.serialize_field("seed", &self.seed)?;
        partial.serialize_field("mod_hash", &self.mod_hash)?;
...
impl<'de> Deserialize<'de> for KmerModHash {
...
impl KmerModHash {
    ...
    pub fn add_hash(&mut self, hash: u64) {
        if hash % self.mod_hash == 0 {
            ...
            if pos == self.mins.len() {
                ...
                // didn't find hash in mins, so inserting somewhere in the middle
    ...
    pub fn merge(&mut self, other: &KmerModHash) -> Result<(), Error> {
    ...
    pub fn add_from(&mut self, other: &KmerModHash) -> Result<(), Error> {
    ...
    pub fn count_common(&self, other: &KmerModHash) -> Result<u64, Error> {
        self.check_compatible(other)?;
    ...
    pub fn intersection(&self, other: &KmerModHash) -> Result<(Vec<u64>, u64), Error> {
        self.check_compatible(other)?;
    ...
    pub fn intersection_size(&self, other: &KmerModHash) -> Result<(u64, u64), Error> {
        self.check_compatible(other)?;
    ...
    pub fn compare(&self, other: &KmerModHash) -> Result<f64, Error> {
        self.check_compatible(other)?;
    ...
    pub fn similarity(&self, other: &KmerModHash, ignore_abundance: bool) -> Result<f64, Error> {
        self.check_compatible(other)?;
    ...
    pub fn containment_ignore_maxhash(&self, other: &KmerModHash) -> Result<f64, Error> {
...
impl SigsTrait for KmerModHash {
    fn size(&self) -> usize {
        self.mins.len()
    }
    ...
    fn check_compatible(&self, other: &KmerModHash) -> Result<(), Error> {
        /*
        ...
        */
        ...
        if self.mod_hash != other.mod_hash {
